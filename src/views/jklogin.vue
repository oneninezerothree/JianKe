...
<div class="login-view view">
    <header id="mallHeader">
        <div>
            <routerLink rel="nofollow" class="back-btn common-header-btn" to="/">
                <i class="icon iconfont icon-back"></i>
            </routerLink>
            <span>用户登录</span>
            <div class="toggle-btn common-header-btn" @touchstart="togglebtn()">
            ...
            <div class="login-wrap">
                ...
                >
                    ...
                    <div class="link">
                        ...
                        <routerLink to="/register" tag="a" class="register-link">注册</routerLink>
                    </div>
                    <!---->
                </div>
...
.page .login-tab .account-login-btn.active,
.page .login-tab .mobile-login-btn.active {
    color: #000;
}

.page .login-tab .account-login-btn,
.page .login-tab .mobile-login-btn {
    width: 50%;
    display: inline-block;
    color: #666;
    position: relative;
...
.page .login-tab .account-login-btn.active:after,
.page .login-tab .mobile-login-btn.active:after {
    content: "";
    position: absolute;
    left: 0;
    bottom: -1px;
...
.page .login-wrap {
    ...
    .mobile-login-box .code-item,
    .mobile-login-box .tel-item {
        position: relative;
...
.page .login-wrap .page .login-wrap .mobile-login-box .captchas-item {
    position: relative;
    border-bottom: 1px solid #efefef;
}
...
.page .login-wrap .mobile-login-box .captchas-item .img-btn {
    position: absolute;
    right: 0;
    bottom: 0.26rem;
    width: 1.52rem;
...
.page .login-wrap .mobile-login-box .code-item,
.page .login-wrap .mobile-login-box .tel-item {
    position: relative;
    border-bottom: 1px solid #efefef;
}
...
.page .login-wrap .mobile-login-box .code-item .code-btn {
    position: absolute;
    right: 0;
    bottom: 0.26rem;
    padding: 0;
...
.page .login-wrap .account-login-box .account-item,
.page .login-wrap .account-login-box .password-item {
    position: relative;
    border-bottom: 1px solid #efefef;
}

.page .login-wrap .account-login-box .account-item .pwd-switch,
.page .login-wrap .account-login-box .password-item .pwd-switch {
    position: absolute;
    right: 0;
    top: 50%;
    transform: translateY(-50%);
